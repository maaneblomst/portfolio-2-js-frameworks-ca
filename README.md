...
I started out by creating a Next project, but after two days of struggeling to combine localStorage with Next, I realized it would not be done in time. Therefore I made the same project in regular React, and added those files via upload. If you would like to see the next-code, I would be happy to share it with you as well.
...
I have used my own Wordpress API to answer this assignment, feel free to use these credentials:

```
user: noroff
password: umDt(JZqGxsE*YYQ30EnWO^e
```

If not, please change the .env-file.
